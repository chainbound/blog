  ...
  servers={[
    {
      ...
      name: 'Beaver',
      code: 'EUS',
      coordinates: [-78.5, 38.9],
    },
    {
      id: 'nethermind_eastus',
      name: 'Nethermind',
      code: 'EUS',
    ...
    },
    {
      ...
      name: 'Flashbots',
      code: 'EUS',
      coordinates: [-74.5, 39.7],
    },
    { id: 'beaver_we', name: 'Beaver', code: 'WE', coordinates: [4.9, 51.5] },
    {
      id: 'nethermind_we',
      name: 'Nethermind',
      code: 'WE',
      coordinates: [6.9, 52.5],
    },
    {
      id: 'flashbots_we',
      name: 'Flashbots',
      code: 'WE',
      coordinates: [8.9, 50.5],
    },
  ]}
  connections={[
    // Transatlantic: Beaver EUS -> Europe (northern route)
    {
      from: 'beaver_eastus',
      to: 'nethermind_we',
...
<GlobalMap
  ...
  connections={[
    // Transatlantic: Beaver EUS -> Europe (high latency routes)
    {
      from: 'beaver_eastus',
      to: 'nethermind_we',
...
days. Latency comparison of P99 latencies befor, each with 24 hours worth of datae and after HTTP/2 for a day's worth of data (all
...
links was reduced significantly. Check out the full comparison of P99 latencies below, each with 24 hours worth of data:
...
<GlobalMap
  ...
  connections={[
    // Transatlantic: Beaver EUS -> Europe
    {
      from: 'beaver_eastus',
      to: 'nethermind_we',
...
There was one more change that we knew would be
impactful, not on latency but on CPU usage.
